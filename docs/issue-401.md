...
今年6月10日，他应牛津大学的学生社团邀请，做了[一次演讲](https://paulgraham.com/earn.html)，题目非常炸裂“如何赚到10亿美元”。
...
SQLite 数据库的作者 Richard Hipp，在[一次采访](https://www.youtube.com/watch?v=x8_ZZhRL3YU&t=1733s)中[解释](https://lobste.rs/s/aqk7vl/pull_requests_are_free_puppies)，为什么他的项目一律不接受外部的 PR。
...
2、[匿名令牌协议 PACT](https://www.cloudflare.com/press/press-releases/2026/cloudflare-collaborates-with-leading-browsers-to-develop-a-privacy-first-protocol-for-the-global-internet/)（英文）

![](https://cdn.beekka.com/blogimg/asset/202606/bg2026062506.webp)

Cloudflare 联合三大浏览器—— Chrome、Firefox、Edge ——宣布开发了一个新协议，用来识别机器人流量。

浏览器会为真人的 HTTP 请求，添加一个令牌，服务器通过这个令牌识别访问者是否为机器人。具体细节还不清楚，可以参考 [Mozilla 的介绍文章](https://hacks.mozilla.org/2026/06/pact-anonymous-credentials-for-the-web/)，理论上有了它就不需要 Captcha 验证码了。

3、[OpenCL 的兴衰](https://www.modular.com/blog/democratizing-ai-compute-part-5-what-about-cuda-c-alternatives)（英文）

![](https://cdn.beekka.com/blogimg/asset/202606/bg2026061502.webp)

一篇回忆文章。21世纪初，一些公司开始设想建立一个 GPU 操作的 C++ 通用框架，但因为各方利益不一致，难以在项目委员会达成共识，最终没有成功。

最终，Nvidia 公司的 CUDA 框架取代了它，变成 GPU 操作的标准方法，Nvidia 也因此成了 AI 硬件的霸主。

4、[停止使用 JWT](https://gist.github.com/samsch/0d1f3d3b4745d778f78b230cf6061452)（英文）

本文认为，JWT 令牌不应该用于保持用户登录状态，那是 Cookie 的功能。JWT 唯一的适用场合就是将用户状态从一台机器转移到另一台机器。

5、[我将网站存储在网站图标（Favicon）中](https://www.timwehrle.de/blog/i-stored-a-website-in-a-favicon/)（英文）

![](https://cdn.beekka.com/blogimg/asset/202606/bg2026062102.webp)

本文提供一个有趣的技巧，网页的实际内容藏在图标文件（Favicon）里面，然后使用 JS 脚本解码渲染。
...
9、[ai\_caption\_video](https://github.com/alexchan197611/ai_caption_video)
...
[8000mAh 手机电池，说明了什么？](https://www.ruanyifeng.com/blog/2025/06/weekly-issue-354.html)（\#354）
