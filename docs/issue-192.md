...
6、[如何排除 .DS\_Store 文件](https://0xmachos.com/2020-01-22-Eradicating-.DS_Store-From-Git/)（英文）

![](https://cdn.beekka.com/blogimg/asset/202201/bg2022011324.webp)

Mac 电脑的文件系统都包含一个隐藏文件 .DS\_Store。提交到 Git 时，它会一起提交，非常讨厌。本文教你一种方法，在 Git 的全局设置里面排除它，不必每个库都设置一次。
